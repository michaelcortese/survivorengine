...
export default {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        if (player.hand.length === 0) {
            return interaction.reply({ content: 'You have no cards to discard!', flags: MessageFlags.Ephemeral });
        }
        ...
        collector.on('collect', async (selectInteraction) => {
            if (selectInteraction.user.id !== interaction.user.id) {
                return selectInteraction.reply({ content: 'This is not your discard menu!', flags: MessageFlags.Ephemeral });
            }
        ...
        buttonCollector.on('collect', async (buttonInteraction) => {
            if (buttonInteraction.user.id !== interaction.user.id) {
                return buttonInteraction.reply({ content: 'This is not your discard menu!', flags: MessageFlags.Ephemeral });
            }
